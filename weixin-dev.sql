...
CREATE TABLE `auth_group` (
  ...
  `parentid` varchar(36) DEFAULT NULL COMMENT '父节点ID',
...
-- ----------------------------
INSERT INTO `auth_group` VALUES ('1', null, 'USER_COMMON', null);
INSERT INTO `auth_group` VALUES ('2', null, 'USER_VIP', null);
INSERT INTO `auth_group` VALUES ('3', null, 'ADMIN', null);
INSERT INTO `auth_group` VALUES ('4', null, 'COMPANY_COMMON', null);
INSERT INTO `auth_group` VALUES ('5', null, 'COMPANY_IMPORTANT', null);
...
-- ----------------------------
INSERT INTO `auth_group_role` VALUES ('1', '1', '1');
...
-- ----------------------------
INSERT INTO `auth_permission` VALUES ('1', 'CREATE', null, null, null, null, null, null, null, null, null);
INSERT INTO `auth_permission` VALUES ('2', 'UPDATE', null, null, null, null, null, null, null, null, null);
INSERT INTO `auth_permission` VALUES ('3', 'SELECT', null, null, null, null, null, null, null, null, null);
INSERT INTO `auth_permission` VALUES ('4', 'DELETE', null, null, null, null, null, null, null, null, null);
INSERT INTO `auth_permission` VALUES ('5', 'ALL', null, null, null, null, null, null, null, null, null);
...
CREATE TABLE `config_email` (
  `id` varchar(64) NOT NULL,
  `model` varchar(255) DEFAULT NULL COMMENT '模式',
  `smtp_server` varchar(64) DEFAULT NULL COMMENT 'smtp服务器',
  `port` varchar(8) DEFAULT NULL COMMENT '端口号',
  `account` varchar(32) DEFAULT NULL COMMENT '邮箱账号',
  `password` varchar(16) DEFAULT NULL,
  `receive_addr` varchar(64) DEFAULT NULL COMMENT '收件箱地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for config_security
-- ----------------------------
DROP TABLE IF EXISTS `config_security`;
CREATE TABLE `config_security` (
  `id` varchar(64) NOT NULL,
  `white_list` varchar(255) DEFAULT NULL COMMENT 'ip白名单',
  `forbid_list` varchar(255) DEFAULT NULL,
  `max_conn` int(5) DEFAULT NULL COMMENT '最大连接数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `region` (
  ...
  `region_order` varchar(32) NOT NULL,
...
-- ----------------------------
INSERT INTO `weixin_config` VALUES ('app_id', 'wx1ee1ab3a4dbdc980');
INSERT INTO `weixin_config` VALUES ('app_secret', 'e9093abacd8cdd038e34e18136f66eed');
INSERT INTO `weixin_config` VALUES ('domain', 'http://5ev9wn.natappfree.cc/');
INSERT INTO `weixin_config` VALUES ('token', 'uuit_test');
...
CREATE TABLE `weixin_menu` (
  ...
  `createTime` datetime DEFAULT NULL,
  `test` int(1) DEFAULT '0' COMMENT '0:不是测试菜单，1:测试菜单',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
